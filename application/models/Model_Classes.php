	...
	*/
	public function create()
	{
		$insert_data = array(
			...
			'class_monthly_fee' => $this->input->post('monthlyFee'),
			'development_fee' => $this->input->post('developmentFee'),
			'exam_fee' => $this->input->post('examFee'),
			'extra_activities' => $this->input->post('extraActivities'),
		);
	...
	*/
	public function update()
	{
		$update_data = array(
			...
			'class_monthly_fee' => $this->input->post('editMonthlyFee'),
			'development_fee' => $this->input->post('editDevelopmentFee'),
			'exam_fee' => $this->input->post('editExamFee'),
			'extra_activities' => $this->input->post('editExtraActivities'),
		);
