...
class TransferCertificate extends MY_Controller 
{
	...
	*/
	...
	public function fetchStudentByClass($classId = null) {
		if($classId) {
			...
			$studentData = $this->Model_StudentPayment->fetchStudentDataByClassforTC($classId);
			foreach ($studentData as $key => $value) {
                ...
                $button = '<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">			  	
				    <li><a href="#" data-toggle="modal" data-target="#editStudentModal" onclick="updateStudent('.$paymentData['payment_name_id'].')">Edit</a></li>
	...
	*/
	public function fetchStudentByClassAndSection($classId = null, $sectionId = null)
	{
		if($classId && $sectionId) {
			$studentData = $this->Model_StudentPayment->fetchStudentByClassAndSectionforTC($classId, $sectionId);
			$result = array('data'=>array());
			foreach ($studentData as $key => $value) {
				$img = '<img src="' . base_url() . $value['image'].'" class="img-circle candidate-photo" alt="Student Image" />';
	...
	public function printStudentPaymentInfo($paymentId = null)
	{
		if($paymentId) {
			...
			<div class="col-md-12" style="border: 1px solid black;"><br/>
			<img src="assets/images/admissionslip.png"/>
			<h4 style=" text-align:center; font-weight:bold; margin-left:320px; box-sizing: content-box;  
			width: 230px;
			height: 20px;
			padding: 5px;  
			border: 1px solid black; border-radius:5px;">TRANSFER CERTIFICATE</h4>
			<table border="0"> 
		 <tr> 
		 ...
		 <tr>
          <td><b>Address : </b>&nbsp;&nbsp;  '.$studentData['f_address'].' </td>
         <td></td>
         </tr>
		 <tr>
      <td><b>Date of Birth Accroding to admission Register : <br/>(in figure)</b>&nbsp;&nbsp;  '.date("d-m-Y", strtotime($studentData['dob'])).' <br/><b>(in words)</b></td>
      <td></td>
      </tr>
	  <tr>
      <td><b>Admission No :</b>&nbsp;&nbsp;  '.$studentData['admssion_no'].'<b style="margin-left:20px;"> Date of Admission</b>&nbsp;&nbsp;  '.$studentData['registerDate'].'</td>
      <td></td>
      </tr>
		 <tr> 
		 <td><b>Class in which he/she studies/studied : </b>&nbsp;&nbsp;  '.$classData['class_name'].'</td> 
		 <td></td> 
		 
	 </tr> 
	 <tr>
      <td><b>Whether he/she qualified /detained for promotion to higher class :</b><input style="border:none;" id="promoted" /></td>
      <td></td>
      </tr>
      <tr>
      <td><b>Date on which he/she left the school:</b><input style="border:none;" id="promoted" /></td>
      <td></td>
      </tr>
      <tr>
      <td><b>Whether he/she pad all the fee :</b><input style="border:none;" id="promoted" /></td>
      <td></td>
      </tr>
      <tr>
      <td><b>Character :</b><input style="border:none;" id="promoted" /></td>
      <td></td>
      </tr>
      ...
      <td><b>
      </br>Signature of Clerk :</b></td>
      <td></td>
      </tr>
    
      <tr>
     
      <td><b> </br>Date of Issue :</b><b style="margin-left:450px;">Principal :</b><br><br></td>
      <td></td>
      </tr>
</table>
