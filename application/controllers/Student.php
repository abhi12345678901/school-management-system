...
class Student extends MY_Controller
{
	...
	*/
	...
	{
		$lastStudent = $this->Model_Student->fetachLastStudent();
		$admissionno = $lastStudent['admssion_no'] + 1;
		if ($lastStudent) {
			$option .= '<option value="' . sprintf('%04u', $admissionno) . '">PCA00' . sprintf('%04u', $admissionno) . '</option>';
			// /foreach
		} else {
			$option .= '<option value="0001">PCA000001</option>';
		}
			...
			foreach ($studentData as $key => $value) {
				...
				$button = '<div class="btn-group">
				  ...
				  <ul class="dropdown-menu">			  	
				    <li><a href="#" data-toggle="modal" data-target="#editStudentModal" onclick="updateStudent(' . $studentId . ')">Edit</a></li>
				    <li><a href="#" data-toggle="modal" data-target="#removeStudentModal" onclick="removeStudent(' . $studentId . ')">Remove</a></li>			    
				  </ul>
				</div>';
