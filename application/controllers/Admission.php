	...
	*/
	public function create()
	{
		...
		$validate_data = array(
			...
			// 			array(
			// 				'field' => 'dcattatch[]',
			// 				'label' => 'Documant Attatched',
			// 				'rules' => 'required'
			// 			),
			// 			array(
			// 				'field' => 'idparents[]',
			// 				'label' => 'Identity of parents',
			// 				'rules' => 'required'
			// 			),
			array(
				'field' => 'className',
			...
			// 			array(
			// 				'field' => 'stadhar',
			// 				'label' => 'Adhar Card No. of Student',
			// 				'rules' => 'required|numeric'
			// 			),
			// 			array(
			// 				'field' => 'parentsadharnumber',
			// 				'label' => 'Adhar Card No. of Parents',
			// 				'rules' => 'required|numeric'
			// 			),
			// 			array(
			// 				'field' => 'stbank',
			// 				'label' => 'Bank Account No. of student',
			// 				'rules' => 'required|numeric'
			// 			),
			// 			array(
			// 				'field' => 'stifsc',
			...
			// 				'field' => 'admssionno',
			// 				'label' => 'Admission No.',
			// 				'rules' => 'required|numeric|is_unique[admission.admssion_no]'
			// 			),
			// 			array(
			// 				'field' => 'registerDate',
		...
		if ($this->form_validation->run() === true) {
			...
			$create = $this->Model_Admission->create($imgUrl);
			if ($create == true) {
