...
<head>
  ...
  <script type="text/javascript" src="<?php echo base_url('assets/jquery/jquery.PrintArea.js') ?>"></script>
  <script type="text/javascript" src="<?php echo base_url('custom/js/print.js') ?>"></script>
  ...
  <nav class="navbar navbar-success bg-success navbar-static-top" style="background-color: midnightblue;">
    <div class="container-fluid">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="<?php echo base_url('dashboard') ?>">PCA</a>
      </div>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown" id="topMarksheetMainNav">
            ...
            <ul class="dropdown-menu">
              ...
              <li id="manageMarksStudent"><a href="<?php echo base_url('marksheet?opt=mgmk') ?>">View Marks</a></li>
              <li id="manageMarksStudentSubject"><a href="<?php echo base_url('marksheetsubject?opt=mgmk') ?>">Manage Marks By Class</a></li>
            </ul>
          </li>

          <li class="dropdown" id="topMarksheetMainNav">
            <a href="<?php echo base_url('transfercertificate?opt=mgst') ?>"> <i class="glyphicon glyphicon-duplicate"></i> Transfer Certificate </a>
          </li>

          <li class="dropdown" id="topAdmission">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-user"></i> Admission <span class="caret"></span></a>

            <ul class="dropdown-menu">
              <li id="admission"><a href="<?php echo base_url('admission?opt=addst') ?>">Add Student</a></li>
              <li id="admissionSlip"><a href="<?php echo site_url('printadmissionslip?opt=crtpay') ?>">Submit Admission Fee</a></li>
              <li id="manageStudentNav"><a href="<?php echo base_url('printadmissionslip?opt=mgpay') ?>">Print Admission Slip</a></li>
            </ul>
          </li>
          <li class="dropdown" id="topAccountMainNav">
            ...
            <ul class="dropdown-menu">
              <!-- <li id="createStudentNav"><a href="<?php echo base_url('accounting?opt=crtpay') ?>">Monthly Student Payment</a></li>     -->
              <li id="managePayNav"><a href="<?php echo base_url('accounting?opt=mgpay') ?>">Monthly Payment</a></li>
