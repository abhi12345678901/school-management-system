  	    	...
  	    	<div class="form-group">
  	    		...
  	    		<div class="col-sm-10">
  	    			<select class="form-control" id="type">
  	    				...
  	    				<option value="1">Submit Admission Fee</option>
  	    			</select>
  	    		</div>
  	    	</div>
  	    </div>
...
<!-- /.edit student's payment -->
<div class="modal fade" tabindex="-1" role="dialog" id="editStudentPay">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      	<div class="modal-header">
        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        	<h4 class="modal-title">Print Admission Slip</h4>
      	...
      	<div class="modal-body">          
      		<div id="edit-student-result"  class="content"></div>      		
    	</div>
      	<!-- /.modal body -->
...
<div class="modal fade" tabindex="-1" role="dialog" id="updateStudentPayment">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      	<div class="modal-header">
        	<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        	<h4 class="modal-title">Edit Student Admission Payment </h4>
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
      	...
      	<div class="modal-body">          
      		<div id="edit-student-payment-result"  class=""></div>      		
    	</div>
      	<!-- /.modal body -->
...
<script type="text/javascript" src="<?php echo base_url('custom/js/printadmissionslip.js') ?>"></script>
