...
<ol class="breadcrumb">
  ...
  if($this->input->get('opt') == 'addst') {
    ...
    echo '<li class="active">Transfer Certificate</li>';
  }
  ...
  <div class="row">
          <div class="col-md-4">
            <div class="panel panel-default">
              ...
              <div class="panel-heading">
                Transfer Certificate Print Section
              </div>

              <div class="list-group">   
              <a type="button" class="list-group-item" href="javascript:void(0);" id="printpayment_button">Print Student List</a>  
              
              <a type="button" class="list-group-item" href="<?php echo base_url('studentpayment?opt=mgst') ?>">Print Student TransferCertificate by Class</a>
                <?php 
                if($classData) {
                  $x = 1;
        ...
        <form class="form-horizontal" method="post" action="studentpayment/updateInfo" id="updateStudentInfoForm">
          ...
          <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="endDate" placeholder="End Date" disabled value="">
				    </div>
			  	  </div>
			  	  <div class="form-group">
				    <label for="className" class="col-sm-4 control-label">Class: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="className" placeholder="Class" disabled value="">
				    </div>
			  	  </div>
			  	  <div class="form-group">
				    <label for="section" class="col-sm-4 control-label">Section: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="section" placeholder="Section" disabled value="">
				    </div>
          </div>
          <div class="form-group">
				    <label for="rollNo" class="col-sm-4 control-label">Roll No: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="rollNo" placeholder="Roll No" disabled value="">
				    </div>
					</div>
					<div class="form-group">
				    <label for="studentName" class="col-sm-4 control-label">Student Name: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="studentName" placeholder="Student Name" disabled value="">
				    </div>
				  </div>
				  <div class="form-group">
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-8">
				<input type="text" class="form-control" id="developmentFee" name="developmentFee" placeholder="Development Fee" value="">
			  </div>
			</div>
			<div class="form-group">
			  ...
			  <div class="col-sm-8">
				<input type="text" class="form-control" id="monthlyFee" name="monthlyFee" placeholder="Tution Fee" value="" readonly>
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8">
				      <input type="date" class="form-control" id="studentPayDate" name="studentPayDate" placeholder="Payment Date" value="">
				    </div>
				  </div>
				  <div class="form-group">
...
<script type="text/javascript" src="<?php echo base_url('custom/js/transfercertificate.js') ?>"></script>
