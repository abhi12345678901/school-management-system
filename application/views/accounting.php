...
<div class="col-md-12">
  <div class="panel panel-primary">
  	    	...
  	    	<div class="form-group">
  	    		...
  	    		<div class="col-sm-10">
  	    			<select class="form-control" id="type">
  	    				...
  	    				<option value="1">Submit Monthly Fee</option>
    ...
    <input type="date" style="margin-bottom: 2px;" id="incomedate">
              <h4>Total By Date : <span id="totalByDate"></span></h4>
...
<div class="col-sm-9">
	<div id="managePaymentDiv" class="payment"></div>	
</div><!-- /.col-sm-9 -->
